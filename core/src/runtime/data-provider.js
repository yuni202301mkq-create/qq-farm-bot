    ...
    return {
        ...
        saveSettings: async (ref, settings) => {
            ...
            const patch = {
                ...
                plantRandomOrder: s.plantRandomOrder,
                plantDelaySec: s.plantDelaySec,
                stealDelaySec: s.stealDelaySec,
            ...
            return {
                ...
                plantRandomOrder: store.getPlantRandomOrder(id),
                plantDelaySec: store.getPlantDelaySec(id),
                stealDelaySec: store.getStealDelaySec(id),
